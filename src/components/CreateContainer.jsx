  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full py-2 border-b border-gray-100 flex items-center gap-2'>
        ...
        <div className='group flex items-center justify-center flex-col border-2 border-dotted
         ...
         <div className='w-full flex flex-col md:flex-row items-center gap-3'>
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            ...
            <input type="text" required placeholder='How much Calories' className='w-full h-full text-lg bg-transparent outline-none
            border-none placeholder:text-gray-500 font-semibold text-textColor'
            value={calories}
          ...
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            ...
            <input type="text" required placeholder='How much Price' className='w-full h-full text-lg bg-transparent outline-none
            border-none placeholder:text-gray-500 font-semibold text-textColor'
            value={price}
