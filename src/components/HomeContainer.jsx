...
function HomeContainer() {
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      <div className='py-2 flex flex-col items-start md:items-start justify-start gap-6'>
        ...
        <p className='text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor'>
          ...
          <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
            ...
            facilis? Itaque laudantium asperiores accusantium dicta beatae. Magni iste, 
            odit, eius minus in saepe, voluptas ab quisquam deserunt praesentium repellendus. Rerum!
            </p>
            ...
            <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap'>
               {
                heroData && heroData.map(n =>(
                    <div key={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-xl flex-col flex items-center justify-center drop-shadow-lg'>
                    ...
                    <p className='text-[12px] lg:text-sm text-lighttextGray font-semibold mt-1 lg:my-3'>{n.decp}</p>
